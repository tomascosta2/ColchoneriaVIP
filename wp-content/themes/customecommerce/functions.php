...
*	Custom Functions
*/
function tcp_cart_count() {
    // Comprueba si WooCommerce está activo
    if (class_exists('WooCommerce')) {
        // Obtiene el objeto global del carrito de WooCommerce
        $cart = WC()->cart;
        
        // Obtiene el número de productos en el carrito
        $productsCount = $cart->get_cart_contents_count();
        
        return $productsCount;
    } else {
        return 0; // WooCommerce no está activo o instalado
    }
}